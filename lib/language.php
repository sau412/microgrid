...
"admin_change_settings_successfull":{
	...
	"de":"Globale Walleteinstellungen geändert"
        },
"register_failed_password_mismatch":{
	...
	"de":"Registrierung fehlgeschlagen. Passwörter stimmen nicht überein."
        },
"register_failed_invalid_password":{
	...
	"de":"Registrierung fehlgeschlagen. Falsches Passwort"
        },
"register_failed_invalid_login":{
	...
	"de":"Registrierung fehlgeschlagen. Ungültiger Login"
        },
"register_failed_invalid_captcha":{
	...
	"de":"Registrierung fehlgeschlagen. Catpcha ungültig."
        },
...
"login_failed_invalid_login":{
	...
	"de":"Login fehlgeschlagen. Falscher Login/Passwort"
        },
"login_failed_invalid_password":{
        "en":"Login failed. Invalid login/password",
	"ru":"Ошибка при входе: неправильный логин или пароль.",
	"fr":"Echec du login. Login/mot de passe invalide.",
	"de":"Login fehlgeschlagen. Falsches Passwort"
        },
"login_failed_invalid_captcha":{
	...
	"de":"Login fehlgeschlagen. Captcha ungültig."
        },
...
"user_change_settings_failed_new_password_mismatch":{
	...
	"de":"Ändern der Einstellungen fehlgeschlagen. Neues Passwort stimmt nicht überein."
        },
"user_change_settings_failed_password_incorrect":{
	...
	"de":"Ändern der Einstellungen fehlgeschlagen. Passwort falsch."
        },
"user_change_settings_successfull":{
	...
	"de":"Ändern der Einstellungen erfolgreich"
        },
"header_greeting":{
        "en":"Welcome,",
	"ru":"Вы вошли как",
...
"footer_about":{
	...
	"de":"Opensource gridcoin online wallet (<a href='https://github.com/sau412/gridcoin_online_wallet'>github link</a>) von Vladimir Tsarev, mein Nickname ist sau412 auf telegram, twitter, facebook, gmail, github, vk."
        },
"login_login":{
        "en":"Login:",
	"ru":"Логин:",
...
"new_address_submit":{
	...
	"de":"Neue Empfangsadresse beantragen"
        },
"register_login":{
        "en":"Login:",
	"ru":"Логин:",
...
"settings_password":{
	...
	"de":"Passwort (benötigt um Einstellungen zu ändern):"
        },
...
"wallet_settings_login_state":{
	...
	"de":"Status der Login/Registrierung:"
        },
